...
async def cals(
    ...
    skies, sky_pos, sky_names = await wrapBlocking(cals.choose_skies)
    standards, stan_pos, stan_ids = await wrapBlocking(cals.choose_standards)
    ...
    cal_dict = {"tile_id": tile_id,
                ...
                "standard_ids": [int(s) for s in stan_ids],
                "sky_names": sky_names,
                "coord_order": ["ra", "dec"]}
